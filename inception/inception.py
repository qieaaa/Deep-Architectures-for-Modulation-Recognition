...
layer11 = Conv2D(50, (1, 1), padding='valid', activation="relu", name="conv11", init='glorot_uniform',
...
layer21 = Conv2D(50, (1, 1), padding='valid', activation="relu", name="conv21", init='glorot_uniform',
                 data_format="channels_first")(input_x_padding)
layer21 = Dropout(dr)(layer21)

layer21 = ZeroPadding2D((0, 2), data_format="channels_first")(layer21)
layer22 = Conv2D(50, (1, 3), padding="valid", activation="relu", name="conv22", init='glorot_uniform',
                 data_format="channels_first")(layer21)
layer22 = Dropout(dr)(layer22)

layer31 = Conv2D(50, (1, 1), padding='valid', activation="relu", name="conv31", init='glorot_uniform',
                 data_format="channels_first")(input_x_padding)
